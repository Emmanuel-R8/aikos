...
*Navigation*: README | Index | Architecture | Memory Management | Display | I/O | Glossary
...
2. *Function Entry*:
   - Load function object (see Function Object in Glossary)
