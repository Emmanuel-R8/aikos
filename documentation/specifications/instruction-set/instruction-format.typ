...
== Endianness pointerCRITICAL: Instruction operands in sysout files are stored in pointerbig-endian byte order pointer. When loading on little-endian hosts, byte-swapping is required.
