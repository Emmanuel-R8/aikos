...
=== Button Mapping pointerTwo-Button Mouse: - Button 1: Left button
- Button 2: Right button
- Middle button: Simulated via modifier + right button pointerThree-Button Mouse: - Button 1: Left button
- Button 2: Middle button
- Button 3: Right button

=== Coordinate System* - *Origin*: Top-left corner (0, 0)* - *X-axis*: Increases rightward* - *Y-axis*: Increases downward* - *Units*: Pixels
...
=== Window Event Types pointerEXPOSE: Window exposed (needs redraw)
*RESIZE*: Window resized pointerFOCUS_IN: Window gained focus pointerFOCUS_OUT: Window lost focus pointerCLOSE: Window close requested
