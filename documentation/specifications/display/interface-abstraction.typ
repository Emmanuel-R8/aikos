...
=== Display Initialization pointerOperation: `initialize_display(width, height, depth, options)`
...
*Semantics*: [`function InitializeDisplay(width, height, depth, options`]:
...
=== Graphics Rendering pointerOperation: `render_region(source_x, source_y, width, height, dest_x, dest_y, operation)`
...
*Semantics*: [`function RenderRegion(source_x, source_y, width, height, dest_x, dest_y, operation`]:
...
=== Window Management pointerOperation: `set_window_title(title)`
...
=== Pixel Formats pointerMonochrome (1 bpp):
...
=== Event Types Keyboard Events: - KEY_PRESS: Key pressed
- KEY_RELEASE: Key released pointerMouse Events: - BUTTON_PRESS: Mouse button pressed
