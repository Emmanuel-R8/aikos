...
=== Stack Management pointerstkmin: Minimum stack space required by function

- Used for stack overflow checking
- Includes frame size and local variables pointerna: Number of arguments - *Positive*: Fixed number of arguments
...
=== Code Location pointerstartpc: Code start offset - *CRITICAL*: This is a BYTE offset from the function header, not a DLword offset!
...
=== Name Table pointerframename: Frame name atom index
