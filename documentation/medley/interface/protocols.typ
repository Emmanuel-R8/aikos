...
1. *Script Initialization  - Parse command-line arguments
...
*Source Code Reference*: medley/scripts/medley/medley_run.sh - startup sequence
 ...
 * - Medley starts fresh session *Source Code Reference*: medley/scripts/medley/medley_args.sh - continuation logic
...
*Source Code Reference*: medley/scripts/medley/medley_args.sh - error handling
...
*Source Code Reference*: medley/scripts/medley/medley_run.sh - exit code handling
...
4. *Termination*: Repeat continues until file is deleted or empty pointerSource Code Reference: medley/scripts/medley/medley_run.sh - repeat protocol
...
5. *VNC Client*: VNC window opens on Windows side pointerSource Code Reference: medley/scripts/medley/medley_vnc.sh - VNC setup
