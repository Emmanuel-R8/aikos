...
1. *New to Medley?* → Start with README.md
2. *Understanding Architecture?* → Read architecture.md
3. *Understanding Medley-Maiko Interface?* → Read interface/README.md
4. *Looking for Terms?* → Check glossary.md
...
- *Configuration*: components/configuration.md - Config files and precedence
- *Greet Files*: components/greetfiles.md - Greet file system
- *Loadup*: components/loadup.md - Loadup workflow and sysout creation
...
- *WSL*: platform/wsl.md - WSL-specific behaviors

== Common Tasks

=== Understanding How Medley Starts

1. *Script System*: components/scripts.md - How scripts parse arguments
2. *Maiko Invocation*: interface/command-line.md - How scripts call Maiko
3. *Environment Setup*: interface/environment.md - Environment variables
4. *Startup Sequence*: interface/protocols.md - Runtime protocols

=== Understanding Sysout Files

1. *Sysout Format*: components/sysout.md - Sysout file structure
2. *File Format Spec*: interface/file-formats.md - Detailed format specification
3. *Loading Process*: components/sysout.md - How sysouts are loaded
4. *Creating Sysouts*: components/loadup.md - Loadup workflow

=== Understanding Virtual Memory Files

1. *Vmem Purpose*: components/vmem.md - Vmem file purpose and usage
2. *Vmem Format*: interface/file-formats.md - Format specification
3. *Session Continuation*: components/vmem.md - How vmem enables persistence

=== Understanding Configuration

1. *Config Files*: components/configuration.md - Config file format
2. *Precedence Rules*: components/configuration.md - How configs are processed
3. *Default Locations*: components/configuration.md - Where configs are found

=== Understanding Platform Differences

1. *Platform Overview*: platform/README.md - Platform documentation overview
2. *Linux*: platform/linux.md - Linux-specific details
3. *macOS*: platform/macos.md - macOS-specific details
4. *Windows*: platform/windows.md - Windows-specific details
5. *WSL*: platform/wsl.md - WSL-specific details
