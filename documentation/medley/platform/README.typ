...
- Standard path conventions pointerSee: Linux Platform Documentation

=== macOS

- macOS-specific script (`medley.command`)
- X11 or SDL display backend
- macOS path handling pointerSee: macOS Platform Documentation
...
- Windows/Cygwin path conventions pointerSee: Windows Platform Documentation
...
- Windows integration pointerSee: WSL Platform Documentation
