...
=== Scripts Used pointerPrimary Scripts: - `medley_run.sh`: Standard shell script (Linux/macOS)
...
4. PATH: `lde` on PATH pointerPlatform Identifiers: - *Intel Macs*: `darwin.x86_64`
