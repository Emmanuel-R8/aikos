...
```
177730 bf 60 00 00 02 0a 12 c9 36 64 a1 68 10 64 6b f0
...
The C emulator trace in `xc_dispatch_part_02.inc` (lines 638-647) shows JUMPX with 2-byte offset formatting, but this is a **trace formatting bug** - the actual execution reads only 1 byte:

```c
case 0xB0: /* JUMPX - 2 byte offset */  // TRACE SAYS 2 BYTES
