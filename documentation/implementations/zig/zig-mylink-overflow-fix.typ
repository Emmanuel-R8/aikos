...
*File*: `documentation/implementations/zig/zig-mylink-overflow-fix.typ`
...
#codeblock(lang: "text", [#raw("thread 2088347 panic: integer overflow
...
#codeblock(lang: "c", [#raw("#define MYALINK \
  do { \
...
2. Error conditions in other functions: Maiko explicitly checks for invalid alink values:
   #codeblock(lang: "c", [#raw("if (alink == 0) error(\"alink is 0 in native_newframe\");
...
#codeblock(lang: "zig", [#raw("// Get alink (activation link to previous frame)
...
#codeblock(lang: "text", [#raw("DEBUG MYALINK: alink=0x00000000, alink_cleared=0x00000000, FRAMESIZE*2=20
DEBUG MYALINK: POTENTIAL UNDERFLOW - alink_cleared=0x00000000 < FRAMESIZE*2=20
thread 2088347 panic: integer overflow")])

=== After Fix

#codeblock(lang: "text", [#raw("DEBUG MYALINK: alink=0 encountered - should be ENDSTACKMARK (0xb) at stack boundary
