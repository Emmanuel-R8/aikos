...
- `documentation/specifications/vm-core/stack-management.typ` - Frame structure documentation (general knowledge)
- `documentation/specifications/memory/address-translation.typ` - Address translation investigation (general knowledge)
- `documentation/specifications/data-structures/sysout-byte-swapping.typ` - Endianness documentation
