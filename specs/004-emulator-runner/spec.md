...
- Q: For `specs/004-emulator-runner/spec.md`, how should we treat the “compare C vs Zig execution traces and make Zig match C” work? → A: Expand this spec to include execution-trace comparison + parity work (and update Out of Scope accordingly).
