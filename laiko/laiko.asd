;;; ASDF system definition for Laiko Lisp
;;; Requires ASDF to be loaded first

(asdf:defsystem "laiko"
  :description "Laiko emulator implementation in Common Lisp"
  :version "0.1.0"
  :author "Laiko Project"
  :license "Same as Laiko"
  :depends-on ()
