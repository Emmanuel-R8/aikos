...
pub const handleFVARX = variable_access.handleFVARX;
...
pub const handleCONTEXTSWITCH = misc.handleCONTEXTSWITCH;
...
// handleRECLAIMCELL, handleGCSCAN1, handleGCSCAN2 already exported above (lines 141-143)
