...
/// READFLAGS: Read system flags
/// Per C implementation: System flag access
pub fn handleREADFLAGS(vm: *VM) errors.VMError!void {
    // TODO: Implement system flag reading
    // For now, return a default value
    try stack.tosPush(vm, 0); // Return 0 flags for now
}

/// GCSCAN1: GC scan phase 1
/// Per C implementation: GC scanning phase 1
pub fn handleGCSCAN1(vm: *VM) errors.VMError!void {
    const gc = vm.gc orelse {
        // No GC available - ignore
        return;
    };
...
/// Per C implementation: GC scanning phase 2
