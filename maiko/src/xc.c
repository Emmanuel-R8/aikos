 ...
 */
   ...
   */
  {
    ...
    const char *const opcode_array[] = {
        ...
        "BIN", "BOUT", "POPDISP", "RESTLIST", "MISCN", "UNUSED_37", "RPLCONS", "LISTGET",
        "UNUSED_40", "UNUSED_41", "UNUSED_42", "UNUSED_43", "EVAL", "ENVCALL", "TYPECHECK", "STKSCAN",
        "BUSBLT", "MISC8", "UBFLOAT3", "TYPEMASK_N", "RDPROLOGPTR", "RDPROLOGTAG", "WRTPTRTAG", "WRTPTR0TAG",
        "MISC7", "DOVEMISC", "EQL", "DRAWLINE", "STORE_N", "COPY_N", "RAID", "SLRETURN",
        ...
        "PVAR_0", "PVAR_1", "PVAR_2", "PVAR_3", "PVAR_4", "PVAR_5", "PVAR_6", "PVARX_",
        "GVAR", "ARG0", "IVARX_", "FVARX_", "COPY", "MYARGCOUNT", "MYALINK", "ACONST",
        "NIL", "T", "0", "1", "SIC", "SNIC", "SICX", "GCONST",
        "UNUSED_112", "READFLAGS", "READRP", "WRITEMAP", "READPRINTERPORT", "WRITEPRINTERPORT", "PILOTBITBLT", "RCLK",
        "MISC1", "MISC2", "RECLAIMCELL", "GCSCAN1", "GCSCAN2", "SUBRCALL", "CONTEXTSWITCH", "RETCALL",
        ...
        "PVARSETPOP0", "PVARSETPOP1", "PVARSETPOP2", "PVARSETPOP3", "PVARSETPOP4", "PVARSETPOP5", "PVARSETPOP6", "POP",
        "POP_N", "ATOMCELL_N", "GETBASEBYTE", "INSTANCEP", "BLT", "MISC10", "P_MISC2", "PUTBASEBYTE",
        "GETBASE_N", "GETBASEPTR_N", "GETBITS_N_FD", "UNUSED_203", "CMLEQUAL", "PUTBASE_N", "PUTBASEPTR_N", "PUTBITS_N_FD",
        "ADDBASE", "VAG2", "HILOC", "LOLOC", "PLUS2", "DIFFERENCE", "TIMES2", "QUOTIENT",
        "IPLUS2", "IDIFFERENCE", "ITIMES2", "IQUOTIENT", "IREMAINDER", "IPLUS_N", "IDIFFERENCE_N", "BASE_LESSTHAN",
        "LLSH1", "LLSH8", "LRSH1", "LRSH8", "LOGOR2", "LOGAND2", "LOGXOR2", "LSH",
        "FPLUS2", "FDIFFERENCE", "FTIMES2", "FQUOTIENT", "UBFLOAT2", "UBFLOAT1", "AREF2", "ASET2",
        "EQ", "IGREATERP", "FGREATERP", "GREATERP", "EQUAL", "MAKENUMBER", "BOXIPLUS", "BOXIDIFFERENCE",
        "FLOATBLT", "FFTSTEP", "MISC3", "MISC4", "UPCTRACE", "SWAP", "NOP", "CL_EQUAL"};
    ...
    {
      opcode_name = opcode_array[opcode];
    }
