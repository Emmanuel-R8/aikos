...
**Navigation**: [README](../README.md) | [Index](../INDEX.md) | [Architecture](../architecture.md)
...
- [VM Core](../components/vm-core.md) - Execution engine architecture
- [Memory Management](../components/memory-management.md) - GC and memory layout
- [Display](../components/display.md) - Display subsystem architecture
- [I/O](../components/io.md) - I/O subsystem architecture
- [Instruction Set](../rewrite-spec/instruction-set/opcodes.md) - Opcode specifications
