...
*See*: Interface - Protocols for startup sequence details
...
- medley/scripts/medley/medley_args.sh - Greet file resolution and LDEINIT setup
...
- *Directory Structure*: Directory Structure Component - Greet file locations
- *Interface - File Formats*: File Formats - Greet file format specification
- *Interface - Environment Variables*: Environment Variables - LDEINIT and LDEREMCM variables
- *Interface - Protocols*: Protocols - Startup sequence and execution
