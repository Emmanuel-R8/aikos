...
*See*: Interface - File Formats for detailed format specification
...
*Source Code Reference*: medley/scripts/medley/medley_run.sh - vmem loading
...
*See*: Directory Structure Component for LOGINDIR details
...
*Source Code Reference*: medley/scripts/medley/medley_run.sh - vmem directory creation
