...
**Navigation**: [README](../README.md) | [Index](../INDEX.md) | [Architecture](../architecture.md) | [VM Core](vm-core.md) | [Memory Management](memory-management.md) | [I/O](io.md) | [Glossary](../glossary.md)

The Display component provides graphics output abstraction across X11 and SDL subsystems.

**Related Components**:

- [VM Core](vm-core.md) - Uses display for output
- [I/O Systems](io.md) - Keyboard and mouse events from display
...
- **X11**: X Window System integration (primary) (see [X11 Implementation](#x11-implementation))
- **SDL**: Simple DirectMedia Layer (alternative) (see [SDL Implementation](#sdl-implementation))

Both backends provide the same interface to the VM core through the display interface abstraction (see [Display Interface Abstraction](#display-interface-abstraction)).
...
- [I/O Systems](io.md) - Keyboard and mouse input
- [VM Core](vm-core.md) - Uses display for output
