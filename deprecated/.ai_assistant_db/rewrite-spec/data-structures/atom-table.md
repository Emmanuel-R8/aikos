...
**Navigation**: [Data Structures README](README.md) | [Function Calls](../vm-core/function-calls.md)
...
- [Function Calls](../vm-core/function-calls.md) - How function calls use DefCell
- [Memory Layout](../memory/memory-layout.md) - Overall memory organization
