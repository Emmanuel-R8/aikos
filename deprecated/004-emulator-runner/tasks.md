...
- [x] T008 [US4] Define canonical trace line format (required fields + ordering) in `specs/contracts/run-scripts-api.md` (FR-021)
...
- [x] T016 [US4] Update parity documentation to mention `EMULATOR_MAX_STEPS` for fast iteration in `specs/quickstart.md` and `specs/contracts/run-scripts-api.md` (FR-022, FR-026)
...
- [x] T018 [US4] Complete memory-loading integration verification task D014 described in `specs/execution-debugging-tasks.md` (Zig: `zaiko/src/data/sysout.zig`)
...
- [ ] T033 [P] Run a consistency pass on docs and contracts for lock file details and parity workflow wording in `specs/contracts/*` and `specs/quickstart.md` (FR-016..FR-018, FR-019..FR-026)
- [ ] T034 Validate `specs/quickstart.md` commands end-to-end on the target platform(s) (SC-006, SC-008, SC-009, SC-010)
