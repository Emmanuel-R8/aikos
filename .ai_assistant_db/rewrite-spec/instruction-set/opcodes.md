...
- [Control Flow & Memory Operations](opcodes-control-memory.md) - Control flow, function calls, jumps, variable access
- [Data Operations](opcodes-data.md) - Cons cells, arrays, types, lists
- [Arithmetic & Base Operations](opcodes-arithmetic.md) - Arithmetic, comparisons, bitwise, base address operations
- [Reference Information](opcodes-reference.md) - Unused opcodes, common misconceptions, length reference, patterns
...
- [Control Flow & Memory Operations](opcodes-control-memory.md)
- [Data Operations](opcodes-data.md)
- [Arithmetic & Base Operations](opcodes-arithmetic.md)
- [Reference Information](opcodes-reference.md)
