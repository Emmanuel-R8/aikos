...
**Navigation**: [README](README.md) | [Opcodes](opcodes.md) | [Execution Semantics](execution-semantics.md)
...
- [Opcodes Reference](opcodes.md) - Complete opcode list with operand formats
- [Execution Semantics](execution-semantics.md) - How instructions execute
- [VM Core Execution Model](../vm-core/execution-model.md) - Dispatch loop implementation
