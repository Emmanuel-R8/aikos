...
**Navigation**: [README](README.md) | [Instruction Format](instruction-format.md) | [Opcodes](opcodes.md)
...
- [Opcodes Reference](opcodes.md) - Complete opcode list
- [Instruction Format](instruction-format.md) - Encoding details
- [VM Core Execution Model](../vm-core/execution-model.md) - Dispatch implementation
- [Stack Management](../vm-core/stack-management.md) - Stack operations
