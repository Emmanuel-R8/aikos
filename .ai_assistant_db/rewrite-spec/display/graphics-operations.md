...
**Navigation**: [README](README.md) | [Interface Abstraction](interface-abstraction.md) | [Event Protocols](event-protocols.md)
...
- [Event Protocols](event-protocols.md) - Input event handling
- [Platform Abstraction](../platform-abstraction/) - Platform-specific details
