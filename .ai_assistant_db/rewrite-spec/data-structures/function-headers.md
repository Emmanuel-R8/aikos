...
**Navigation**: [README](README.md) | [Cons Cells](cons-cells.md) | [Arrays](arrays.md)
...
- [VM Core](../vm-core/) - Function call mechanism
- [Stack Management](../vm-core/stack-management.md) - Frame structure
- [Memory Management](../memory/) - Function allocation
