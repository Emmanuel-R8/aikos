...
**Navigation**: [README](README.md) | [Execution Model](execution-model.md) | [Stack Management](stack-management.md)
...
- [Stack Management](stack-management.md) - Frame structure and management
- [Execution Model](execution-model.md) - How calls integrate with dispatch
- [Instruction Set](../instruction-set/) - Function call opcodes
