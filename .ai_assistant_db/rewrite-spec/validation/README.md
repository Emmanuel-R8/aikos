...
See [Reference Behaviors](reference-behaviors.md) for specific test cases.

## Compatibility Criteria

See [Compatibility Criteria](compatibility-criteria.md) for what must match exactly.

## Related Documentation

- [Instruction Set](../instruction-set/) - Opcode specifications
- [VM Core](../vm-core/) - Execution model
- [Memory Management](../memory/) - GC and memory
