...
**Navigation**: [README](README.md) | [Keyboard Protocol](keyboard-protocol.md) | [Mouse Protocol](mouse-protocol.md) | [Network Protocol](network-protocol.md)
...
- [Network Protocol](network-protocol.md) - Network file access
- [Platform Abstraction](../platform-abstraction/) - Platform-specific differences
