...
**Note**: General findings about non-existent opcodes have been documented in the emulator-independent [Opcodes Reference](../../rewrite-spec/instruction-set/opcodes.md#common-misconceptions-non-existent-opcodes). This document focuses on Zig-specific implementation details and conflicts encountered during development.
