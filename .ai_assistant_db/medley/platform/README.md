...
- **[Linux](linux.md)**: Standard Linux systems
- **[macOS](macos.md)**: macOS systems (Darwin)
- **[Windows](windows.md)**: Windows/Cygwin systems
- **[WSL](wsl.md)**: Windows Subsystem for Linux (WSL1 and WSL2)
...
**Source Code Reference**: [medley/scripts/medley/medley_main.sh](medley/scripts/medley/medley_main.sh) - platform detection
...
**See**: [Linux Platform Documentation](linux.md)
...
**See**: [macOS Platform Documentation](macos.md)
...
**See**: [Windows Platform Documentation](windows.md)
...
**See**: [WSL Platform Documentation](wsl.md)
