...
**See**: [Command-Line Interface](command-line.md)
...
1. **Command-Line Arguments**: [command-line.md](command-line.md) - How Medley flags map to Maiko flags
2. **Environment Setup**: [environment.md](environment.md) - Environment variables set by Medley
3. **File Resolution**: [file-formats.md](file-formats.md) - How files are located and passed to Maiko
4. **Invocation**: [protocols.md](protocols.md) - How scripts invoke Maiko

### Understanding File Formats

1. **Sysout Format**: [file-formats.md](file-formats.md#sysout-file-format) - Sysout file structure
2. **Vmem Format**: [file-formats.md](file-formats.md#vmem-file-format) - Vmem file structure
3. **Config Format**: [file-formats.md](file-formats.md#config-file-format) - Config file format
4. **Greet Format**: [file-formats.md](file-formats.md#greet-file-format) - Greet file format

### Understanding Communication Flow

1. **Startup Sequence**: [protocols.md](protocols.md#startup-sequence) - Complete startup flow
2. **Error Handling**: [protocols.md](protocols.md#error-handling) - Error handling patterns
3. **Session Management**: [protocols.md](protocols.md#session-management) - Run ID and vmem coordination

## Integration with Component Documentation

Interface documentation complements component documentation:

- **Scripts Component**: [../components/scripts.md](../components/scripts.md) - How scripts use the interface
- **Sysout Component**: [../components/sysout.md](../components/sysout.md) - Sysout files in context
- **Vmem Component**: [../components/vmem.md](../components/vmem.md) - Vmem files in context
- **Configuration Component**: [../components/configuration.md](../components/configuration.md) - Config files in context
- **Greet Files Component**: [../components/greetfiles.md](../components/greetfiles.md) - Greet files in context
...
4. **Check Platform Docs**: Review platform-specific variations in [../platform/](../platform/)
