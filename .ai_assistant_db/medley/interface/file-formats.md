...
**See**: [Virtual Memory Files Component](../components/vmem.md) for vmem file usage and purpose
...
**See**: [Virtual Memory Files Component](../components/vmem.md#vmem-file-resolution) for location resolution
...
**See**: [Configuration Files Component](../components/configuration.md) for config file usage and purpose
...
**See**: [Configuration Files Component](../components/configuration.md#config-file-locations) for location details
...
**Source Code Reference**: [medley/scripts/medley/medley_configfile.sh](medley/scripts/medley/medley_configfile.sh) - config file parsing
...
**See**: [Greet Files Component](../components/greetfiles.md) for greet file usage and purpose
...
**See**: [Greet Files Component](../components/greetfiles.md#greet-file-resolution) for location details
...
**See**: [Greet Files Component](../components/greetfiles.md#greet-file-execution) for execution details
...
**See**: [Greet Files Component](../components/greetfiles.md#remcm-files) for REM.CM file details
...
- **Sysout Files**: [Sysout Files Component](../components/sysout.md) - Sysout file usage
- **Virtual Memory Files**: [Virtual Memory Files Component](../components/vmem.md) - Vmem file usage
- **Configuration Files**: [Configuration Files Component](../components/configuration.md) - Config file usage
